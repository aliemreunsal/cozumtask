...
{
    public class SiyahKale : Siyah, ISiyah//Kale nesnelerinin konumları ve puanları ile oluşturulmasını ve tehdit ettiği karelerin belirlenmesi için oluşturulan sınıf.
    {
        public override int Puan { get; set; }

        public SiyahKale(int a, int b) : base(a, b)
        {
            Puan = 5;
        }
