...
{
    public class SiyahSah : Siyah, ISiyah//Şah nesnelerinin konumları ve puanları ile oluşturulmasını ve tehdit ettiği karelerin belirlenmesi için oluşturulan sınıf.
    {
        public override int Puan { get; set; }

        public SiyahSah(int a, int b) : base(a, b)
        {
            Puan = 100;
        }
