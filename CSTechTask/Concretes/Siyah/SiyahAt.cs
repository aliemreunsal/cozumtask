...
{
    public class SiyahAt : Siyah, ISiyah//At nesnelerinin konumları ve puanları ile oluşturulmasını ve tehdit ettiği karelerin belirlenmesi için oluşturulan sınıf.
    {
        public override int Puan { get; set; }
        public SiyahAt(int a, int b) : base(a, b)
        {
            Puan = 3;
        }
