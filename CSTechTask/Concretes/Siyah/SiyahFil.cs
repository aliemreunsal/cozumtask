...
{
    public class SiyahFil : Siyah, ISiyah//Fil nesnelerinin konumları ve puanları ile oluşturulmasını ve tehdit ettiği karelerin belirlenmesi için oluşturulan sınıf.
    {
        public override int Puan { get; set; }

        public  SiyahFil(int a, int b) : base(a, b)
        {
            Puan = 3;
        }
